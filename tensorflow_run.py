...
exec_time=(end - start)
print('\nThe time taken to import and prepare training data for Tensorflow is:',exec_time)
...
exec_time=(end - start)
print('\nThe time taken to import and prepare testing data for Tensorflow is:',exec_time)
